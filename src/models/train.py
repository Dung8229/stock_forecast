...
from src.utils.s3_io import upload_df_to_s3, download_df_from_s3
...
def train_model(train_df: pd.DataFrame, test_df: pd.DataFrame, n_trials: int = 20):
    ...
    def optuna_objective(trial):
        ...
        # The code is a bit cumbersome since MLflow's `log_params` doesn't take Optuna's trial as its argument
